...
public class User {
	...
	public String toString() {
		...
		builder.append("User [id=").append(id).append(", full_name=").append(full_name).append(", email=").append(email)
				.append(", profile_picture=").append(profile_picture).append(", password=").append(password)
				.append("]");
